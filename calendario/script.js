document.addEventListener('DOMContentLoaded', () => {
    const apiURL = 'https://superflixapi.shop/calendario.php';
    ...
    // ========================================================================
    // LAZY LOADING (CÓDIGO ADICIONADO PARA CORRIGIR O PROBLEMA)
    // ========================================================================
    ...
    function setupLazyLoader() {
        const options = {
            ...
            rootMargin: '0px 0px 200px 0px', // Carrega 200px antes de ser visível
            threshold: 0.01
        };
        ...
        lazyImageObserver = new IntersectionObserver((entries, observer) => {
            entries.forEach(entry => {
                if (entry.isIntersecting) {
                    ...
                    lazyImage.classList.remove('lazy-load'); // Remove a classe para não observar novamente
                    lazyImage.onerror = () => { // Caso a imagem real falhe
                        lazyImage.src = 'https://placehold.co/185x278/1f2937/FFFFFF?text=N/A';
                    };
